...
from .utils import ANSWER_LIST, SHORT_QUESTION_LIST, QWEN25VL_ANSWER_LIST, QWEN25VL_QUESTION_LIST
...
class SemSegDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        use_qwen25vl_format=False,
    ):
        self.exclude_val = exclude_val
        self.samples_per_epoch = samples_per_epoch
        self.num_classes_per_sample = num_classes_per_sample
        self.use_qwen25vl_format = use_qwen25vl_format
        ...
        if self.use_qwen25vl_format:
            self.short_question_list = QWEN25VL_QUESTION_LIST
            self.answer_list = QWEN25VL_ANSWER_LIST
        else:
    ...
    def __getitem__(self, idx):
        ...
        for sampled_cls in sampled_classes:
            ...
            # Choose answer template and format it
            answer_template = random.choice(self.answer_list)
            if self.use_qwen25vl_format:
                # For Qwen2.5VL format, replace {class_name} in the answer template
